...
def set_properties(project):
    ...
    # Project Manifest
    project.summary = "A pybuilder plugin that stages a python package into a docker container " \
                      "and optionally publishes it to a registry."
    project.home_page = "https://github.com/AlienVault-Engineering/pybuilder-docker"
    project.description = "A pybuilder plugin that stages a python package into a docker container " \
                          "and optionally publishes it to a registry."
